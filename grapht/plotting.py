...
__all__ = ['highlight_edges', 'heatmap', 'get_graph_tool_graph', 'grapht_from_sparse_array',
           'symmetric_grapht_from_sparse_array', 'sparse_is_symmetric', 'networkxpos_to_graphtpos', 'sfdp_layout',
           'neato_layout', 'fdp_layout']
...
def networkxpos_to_graphtpos(G, nx_pos):
...
def neato_layout(G):
    return nx.drawing.nx_agraph.graphviz_layout(G, prog='neato')

def fdp_layout(G):
    return nx.drawing.nx_agraph.graphviz_layout(G, prog='fdp')